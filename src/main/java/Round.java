...
public class Round {
    ...
    public void buttonHandler(int cnt) {
        score += tableCubes.get(cnt).countCubePoints();
    ...
    public boolean isComputerRound () {
        return (game.getTable().isComputerPalying()) && (player.equals(game.getPlayer2()));
    }
    ...
    public void checkForRoundsVictory () {
